...
source_path: plugins/xo/hooks/sessionstart.js
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/hooks/sessionstart.js
category: hook
status: active
...
**Type:** Hook
**Hook Name:** `SessionStart`
**Event:** `SessionStart`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `plugins/xo/hooks/sessionstart.js`
**Source URL:** [plugins/xo/hooks/sessionstart.js](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/hooks/sessionstart.js)
**Status:** Active
...
Fires automatically when a Cortex Code session starts or re-initializes.

---

## Purpose

Initializes standing directives for the agent, sets up local diary and task directories, reindexes active Work Items, checks context state, and registers the session ID.

---

## Execution Flow

Reads stdin JSON payload -> Resolves XOCORTEX_HOME & paths -> Writes diary heading for today -> Invokes reindexTasks() to rebuild tasks/index.md -> Builds standing directives -> Emits standing directives into session context.

---

## Inputs

Session metadata payload (session_id, cwd, workspace_root) via stdin.

---

## Outputs

JSON response containing standing directives injected into system context.

---

## Side Effects

Creates diary entry for current date, writes tasks/index.md, updates session logs.

---

## Dependencies

- node, plugins/xo/hooks/_common.js, plugins/xo/hooks/reindex-tasks.js
- [[Plugin - XO]]
...
- **Repository File:** `plugins/xo/hooks/sessionstart.js`
- **GitHub URL:** [Snowflake-Labs/coco-skills/plugins/xo/hooks/sessionstart.js](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/hooks/sessionstart.js)
