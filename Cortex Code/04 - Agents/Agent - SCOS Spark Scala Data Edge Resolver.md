...
name: scos-spark-scala-data-edge-resolver
title: "SCOS Spark Scala Data Edge Resolver"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md
...
tags:
  ...
  - scos-migration
aliases:
  - "SCOS Spark Scala Data Edge Resolver"
  - "scos-spark-scala-data-edge-resolver"
---
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-scala-data-edge-resolver`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Scala Data Edge Resolver in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Scala Data Edge Resolver
...
```text
Spawn subagent scos-spark-scala-data-edge-resolver with role instructions and target parameters.
```
...
- [[Skill - Migrate Spark Scala to Snowpark Connect]]
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/data_edge_resolver.md)
