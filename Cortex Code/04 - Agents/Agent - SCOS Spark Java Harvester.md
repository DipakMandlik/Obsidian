...
name: scos-spark-java-harvester
title: "SCOS Spark Java Harvester"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-java-harvester`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md`
**Source URL:** [skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Java Harvester in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Java Harvester
...
```text
Spawn subagent scos-spark-java-harvester with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/harvester.md)
