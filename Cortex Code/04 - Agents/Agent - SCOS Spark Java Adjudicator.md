...
name: scos-spark-java-adjudicator
title: "SCOS Spark Java Adjudicator"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-java-adjudicator`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Java Adjudicator in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Java Adjudicator
...
```text
Spawn subagent scos-spark-java-adjudicator with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/agents/adjudicator.md)
