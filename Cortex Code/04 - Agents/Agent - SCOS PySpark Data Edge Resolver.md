...
name: scos-pyspark-data-edge-resolver
title: "SCOS PySpark Data Edge Resolver"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md
...
tags:
  ...
  - scos-migration
aliases:
  - "SCOS PySpark Data Edge Resolver"
  - "scos-pyspark-data-edge-resolver"
---
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-data-edge-resolver`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark Data Edge Resolver in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark Data Edge Resolver
...
```text
Spawn subagent scos-pyspark-data-edge-resolver with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/data_edge_resolver.md)
