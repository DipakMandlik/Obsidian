...
name: scos-pyspark-reporter
title: "SCOS PySpark Reporter"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-reporter`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark Reporter in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark Reporter
...
```text
Spawn subagent scos-pyspark-reporter with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/reporter.md)
