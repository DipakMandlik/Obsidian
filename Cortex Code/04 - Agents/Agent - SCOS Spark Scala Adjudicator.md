...
name: scos-spark-scala-adjudicator
title: "SCOS Spark Scala Adjudicator"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-scala-adjudicator`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Scala Adjudicator in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Scala Adjudicator
...
```text
Spawn subagent scos-spark-scala-adjudicator with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/adjudicator.md)
