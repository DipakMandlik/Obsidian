...
name: scos-spark-java-local-runner
title: "SCOS Spark Java Local Runner"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-java-local-runner`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md`
**Source URL:** [skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Java Local Runner in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Java Local Runner
...
```text
Spawn subagent scos-spark-java-local-runner with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-spark-java-to-snowpark-connect/agents/local-runner.md)
