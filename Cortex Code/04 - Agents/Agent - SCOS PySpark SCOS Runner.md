...
name: scos-pyspark-scos-runner
title: "SCOS PySpark SCOS Runner"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-scos-runner`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md`
**Source URL:** [skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark SCOS Runner in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark SCOS Runner
...
```text
Spawn subagent scos-pyspark-scos-runner with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/scos-runner.md)
