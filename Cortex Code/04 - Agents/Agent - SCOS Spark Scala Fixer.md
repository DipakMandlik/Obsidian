...
name: scos-spark-scala-fixer
title: "SCOS Spark Scala Fixer"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-spark-scala-fixer`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS Spark Scala Fixer in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS Spark Scala Fixer
...
```text
Spawn subagent scos-spark-scala-fixer with role instructions and target parameters.
```
...
3. **Branch each issue on `kind` FIRST** (recipe-aware shortcut — see
   ...
   - `standard` (default) — apply normal rules below. This covers both
     ...
     Phase 1.1b adjudicator-confirmed rows (`adjudicated=true`).
   - `needs_adjudication` — **fallback only.** The analyzer never calls
     ...
     Phase 1.1b adjudicator *before* you run — confirmed rows arrive as
     ...
     `needs_adjudication` with `adjudicated` false (Phase 1.1b was skipped or a
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-scala-to-snowpark-connect/agents/fixer.md)
