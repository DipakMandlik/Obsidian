...
name: scos-pyspark-data-synthesizer
title: "SCOS PySpark Data Synthesizer"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-data-synthesizer`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md`
**Source URL:** [skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark Data Synthesizer in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark Data Synthesizer
...
```text
Spawn subagent scos-pyspark-data-synthesizer with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/data-synthesizer.md)
