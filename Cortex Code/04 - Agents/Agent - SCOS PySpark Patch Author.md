...
name: scos-pyspark-patch-author
title: "SCOS PySpark Patch Author"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-patch-author`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md`
**Source URL:** [skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark Patch Author in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark Patch Author
...
```text
Spawn subagent scos-pyspark-patch-author with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/validate-pyspark-to-snowpark-connect/agents/patch-author.md)
