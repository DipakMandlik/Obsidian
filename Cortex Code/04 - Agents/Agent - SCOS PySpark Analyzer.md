...
name: scos-pyspark-analyzer
title: "SCOS PySpark Analyzer"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md
...
**Type:** Cortex Code Agent
**Agent Name:** `scos-pyspark-analyzer`
**Source:** Snowflake-Labs/coco-skills
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md)
**Status:** Available
...
Execute specialized sub-phase operations for SCOS PySpark Analyzer in the Snowpark Connect (SCOS) migration and validation pipeline.

---

## Responsibilities

- Perform deterministic execution for SCOS PySpark Analyzer
...
```text
Spawn subagent scos-pyspark-analyzer with role instructions and target parameters.
```
...
- **Repository File:** `skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-pyspark-to-snowpark-connect/agents/analyzer.md)
