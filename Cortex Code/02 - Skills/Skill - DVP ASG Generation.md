...
title: "DVP ASG Generation"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md)
**Status:** Available
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **DVP ASG Generation**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
Help me with DVP ASG Generation
```
...
- `Run DVP ASG Generation workflow for my Snowflake account`
...
- **Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-asg-generation/SKILL.md)
