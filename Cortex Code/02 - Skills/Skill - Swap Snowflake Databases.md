...
source_path: skills/swap-databases/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/swap-databases/SKILL.md
...
**Repository Path:** `skills/swap-databases/SKILL.md`
**Source URL:** [skills/swap-databases/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/swap-databases/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `swap databases, rename database, swap DB names, database cutover, blue-green swap, exchange databases, redirect dependencies, read-only database, replace shared database, migrate references, migrate sfshares, abstracted views, migrate views, zerocopy, datashare, catalog linked database, CLD, SYSTEM$ZEROCOPY_SWAP`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Swap Snowflake Databases**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
Swap databases MY_DB_OLD and MY_DB_NEW
```
...
- **Repository Path:** `skills/swap-databases/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/swap-databases/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/swap-databases/SKILL.md)
