...
source_path: skills/solutions-installer/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/solutions-installer/SKILL.md
category: solutions
status: active
...
**Repository Path:** `skills/solutions-installer/SKILL.md`
**Source URL:** [skills/solutions-installer/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/solutions-installer/SKILL.md)
**Status:** Available
...
Install pre-built industry solutions into your Snowflake account from the sf-solutions repository.
...
**Verified Triggers:** `install solution, coco solutions install, set up solution, deploy solution,`

---

## When Not To Use

adding pages to the solutions catalog website (use snowflake-solutions-catalog instead), building custom solutions from scratch, or general SQL authoring.

---

## What It Enables

This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Install Snowflake Solutions**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
$solutions-installer <solution-name>
```
...
- **Repository Path:** `skills/solutions-installer/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/solutions-installer/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/solutions-installer/SKILL.md)
