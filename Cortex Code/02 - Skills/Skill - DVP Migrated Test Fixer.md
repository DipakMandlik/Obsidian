...
title: "DVP Migrated Test Fixer"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md)
**Status:** Available
...
Fix migrated Snowpark test code until all tests PASS (not just run). Uses git-based iteration to diagnose and resolve PySpark-to-Snowpark API incompatibilities. Triggers: fix migrated tests, make migrated tests pass, snowpark test errors, migration test failures.
...
**Verified Triggers:** `fix migrated tests, make migrated tests pass, snowpark test errors, migration test failures`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **DVP Migrated Test Fixer**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- `fix migrated tests`
- `make migrated tests pass`
- `snowpark test errors`
...
- **Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-migrated-test-fixer/SKILL.md)
