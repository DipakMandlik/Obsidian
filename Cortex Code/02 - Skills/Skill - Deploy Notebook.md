...
source_path: skills/spark-migration/deploy-notebook/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-notebook/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/deploy-notebook/SKILL.md`
**Source URL:** [skills/spark-migration/deploy-notebook/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-notebook/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `deploy notebook, deploy migrated notebook, create notebook from migration output,`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Deploy Notebook**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- `deploy notebook`
- `deploy migrated notebook`
- `create notebook from migration output`
...
- **Repository Path:** `skills/spark-migration/deploy-notebook/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/deploy-notebook/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-notebook/SKILL.md)
