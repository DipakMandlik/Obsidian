...
title: "Snowpark Connect"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/snowpark-connect/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-connect/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `snowpark connect, scos, pyspark migration, spark connect, scala spark migration,`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Snowpark Connect**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Repository Path:** `skills/spark-migration/snowpark-connect/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/SKILL.md)
