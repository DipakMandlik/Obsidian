...
source_path: skills/snowpipe-bcdr/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/snowpipe-bcdr/SKILL.md
...
**Repository Path:** `skills/snowpipe-bcdr/SKILL.md`
**Source URL:** [skills/snowpipe-bcdr/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/snowpipe-bcdr/SKILL.md)
**Status:** Available
...
Snowpipe disaster recovery patterns for Azure ADLS Gen2 with failover, failback, and catchup procedures.
...
**Verified Triggers:** `snowpipe BCDR, snowpipe disaster recovery, snowpipe failover, dual pipe, active-active pipe, RA-GRS snowpipe, GZRS snowpipe, snowpipe catchup, pipe failback, snowpipe high availability, failover group snowpipe, snowpipe RPO RTO`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Snowpipe BCDR on Azure**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
Help me design and implement a Snowpipe BCDR pattern on Azure ADLS Gen2 with failover and catchup.
```
...
- **Repository Path:** `skills/snowpipe-bcdr/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/snowpipe-bcdr/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/snowpipe-bcdr/SKILL.md)
