...
name: refactor
title: "Spec-Driven Refactor"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spec-driven/refactor/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/refactor/SKILL.md
category: sdlc
status: active
...
**Repository Path:** `skills/spec-driven/refactor/SKILL.md`
**Source URL:** [skills/spec-driven/refactor/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/refactor/SKILL.md)
**Status:** Available
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Spec-Driven Refactor**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
Help me with Spec-Driven Refactor
```
...
- `Run Spec-Driven Refactor workflow for my Snowflake account`
...
- **Repository Path:** `skills/spec-driven/refactor/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spec-driven/refactor/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/refactor/SKILL.md)
