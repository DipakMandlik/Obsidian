...
title: "SMA Dashboard Generator"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `sma dashboard, ewi tracker, track EWIs, conversion issues`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **SMA Dashboard Generator**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
**Note**: The EWI Fixer can be invoked separately via the `spark-migration` skill (which loads `snowpark-api/dvp/dvp-ewi-fixer/SKILL.md` as a bundled sub-skill). It uses the same database, so any changes will be reflected when you refresh the dashboard.
...
- **Repository Path:** `skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/sma-dashboard-generator/SKILL.md)
