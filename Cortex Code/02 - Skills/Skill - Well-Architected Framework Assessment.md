...
source_path: skills/well-architected-framework-assessment/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/well-architected-framework-assessment/SKILL.md
...
**Repository Path:** `skills/well-architected-framework-assessment/SKILL.md`
**Source URL:** [skills/well-architected-framework-assessment/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/well-architected-framework-assessment/SKILL.md)
**Status:** Available
...
Assess a Snowflake account against all five Well-Architected Framework pillars.
...
**Verified Triggers:** `WAF assessment, well-architected, architecture review, WAF review, security assessment, pillar assessment, security and governance, reliability, cost optimization, operational excellence, performance`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **WAF Assessment**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Category:** `architecture-assessment`
- **Related Notes:** [[Cortex Code Skills Master Index]], [[CoCo Quick Access]], [[How to Choose a Cortex Code Skill]], [[Reference - Well-Architected Framework Pillars and Assessment Criteria]], [[Workflow - Well-Architected Framework Account Assessment]]
...
- **Repository Path:** `skills/well-architected-framework-assessment/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/well-architected-framework-assessment/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/well-architected-framework-assessment/SKILL.md)
