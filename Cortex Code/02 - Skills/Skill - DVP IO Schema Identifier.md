...
title: "DVP IO Schema Identifier"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `identify IO, find inputs outputs, map data flow, discover tables files, extract schema`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **DVP IO Schema Identifier**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Repository Path:** `skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/dvp/dvp-io-schema-identifier/SKILL.md)
