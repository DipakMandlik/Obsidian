...
title: "Migrate Spark Java to Snowpark Connect"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md
category: migration
status: active
...
tags:
  ...
  - snowpark-connect
aliases:
  - "Migrate Spark Java to Snowpark Connect"
  - "migrate-spark-java-to-snowpark-connect"
---
...
**Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `migrate java spark, convert java spark, scos java migration,`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Migrate Spark Java to Snowpark Connect**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
*retrieval* only, and every ambiguous finding is deferred to the Phase 1.1b
...
- **Repository Path:** `skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-connect/migrate-spark-java-to-snowpark-connect/SKILL.md)
