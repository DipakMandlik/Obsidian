...
title: "Stage Conversion Embedded File Paths"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/snowpark-api/stage-conversion/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/stage-conversion/SKILL.md
category: migration
status: active
...
tags:
  ...
  - stage-conversion
aliases:
  - "Stage Conversion Embedded File Paths"
  - "stage-conversion"
---
...
**Repository Path:** `skills/spark-migration/snowpark-api/stage-conversion/SKILL.md`
**Source URL:** [skills/spark-migration/snowpark-api/stage-conversion/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/stage-conversion/SKILL.md)
**Status:** Available
...
Replace embedded file paths in SMA-converted Snowpark code. Use when: migrating Spark code via SMA, fixing file path references, updating storage locations, changing stage prefix. Triggers: replace embedded file paths, embedded file paths, file paths, SMA file paths, Snowpark paths, change stage prefix.
...
**Verified Triggers:** `replace embedded file paths, embedded file paths, file paths, SMA file paths, Snowpark paths, change stage prefix`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Stage Conversion Embedded File Paths**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Repository Path:** `skills/spark-migration/snowpark-api/stage-conversion/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/snowpark-api/stage-conversion/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/snowpark-api/stage-conversion/SKILL.md)
