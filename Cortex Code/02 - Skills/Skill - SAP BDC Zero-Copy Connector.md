...
source_path: skills/manage-zerocopy-sapbdc/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/manage-zerocopy-sapbdc/SKILL.md
...
tags:
  ...
  - sap
aliases:
  - "SAP BDC Zero-Copy Connector (Minimal CSN)"
...
**Repository Path:** `skills/manage-zerocopy-sapbdc/SKILL.md`
**Source URL:** [skills/manage-zerocopy-sapbdc/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/manage-zerocopy-sapbdc/SKILL.md)
**Status:** Available
...
Manage the lifecycle of the SAP BDC zero-copy connector with minimal CSN generation (SDK-compatible, no validation loops).
...
**Verified Triggers:** `SAP BDC, SAP connector, minimal CSN, SDK CSN, zerocopy connector,`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **SAP BDC Zero-Copy Connector (Minimal CSN)**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
$manage-zerocopy-sapbdc create a connector and publish with minimal CSN
```
...
- **Repository Path:** `skills/manage-zerocopy-sapbdc/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/manage-zerocopy-sapbdc/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/manage-zerocopy-sapbdc/SKILL.md)
