...
source_path: skills/spec-driven/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/SKILL.md
category: sdlc
status: active
...
**Repository Path:** `skills/spec-driven/SKILL.md`
**Source URL:** [skills/spec-driven/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/SKILL.md)
**Status:** Available
...
SDLC workflow enforcing EARS-notation specs and approval gates before any code is written.
...
**Verified Triggers:** `spec-driven, specification, SDLC, EARS, implement feature, fix bug, refactor,`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Spec-Driven Development**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
```text
$spec-driven I want to build a new feature for user authentication
```
...
- **Repository Path:** `skills/spec-driven/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spec-driven/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spec-driven/SKILL.md)
