...
title: "Deploy Code Bundle"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/spark-migration/deploy-code-bundle/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-code-bundle/SKILL.md
category: migration
status: active
...
**Repository Path:** `skills/spark-migration/deploy-code-bundle/SKILL.md`
**Source URL:** [skills/spark-migration/deploy-code-bundle/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-code-bundle/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `deploy code bundle, deploy to code bundle, run as code bundle, create`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **Deploy Code Bundle**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Repository Path:** `skills/spark-migration/deploy-code-bundle/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/skills/spark-migration/deploy-code-bundle/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/spark-migration/deploy-code-bundle/SKILL.md)
