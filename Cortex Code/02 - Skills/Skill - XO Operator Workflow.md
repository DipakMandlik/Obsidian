...
name: xo
title: "XO Operator Workflow"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/SKILL.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/SKILL.md
...
**Repository Path:** `plugins/xo/skills/xo/SKILL.md`
**Source URL:** [plugins/xo/skills/xo/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/SKILL.md)
**Status:** Available
...
**Verified Triggers:** `work item, WI, task, implement, investigate, plan, review, execute, what should I do, where do I start, savepoint, resume`
...
This skill provides Cortex Code with deterministic, domain-specific execution patterns for **XO Operator Workflow**, enforcing safety, verification standards, and optimal Snowflake resource utilization without hallucinating commands or grants.
...
- **Category:** `workflow-harness`
- **Related Notes:** [[Cortex Code Skills Master Index]], [[CoCo Quick Access]], [[How to Choose a Cortex Code Skill]], [[Plugin - XO]], [[Workflow - XO Operator OODA Loop]], [[Agent - XO Bounded Writer]], [[Agent - XO Cold Fast]], [[Agent - XO Cold Smart]], [[Agent - XO Generator]]
...
- **Repository Path:** `plugins/xo/skills/xo/SKILL.md`
- **GitHub URL:** [Snowflake-Labs/coco-skills/plugins/xo/skills/xo/SKILL.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/SKILL.md)
