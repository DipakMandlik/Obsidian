...
title: "Reference - XO Save Context Urgency"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/save-context-urgency.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-context-urgency.md
...
tags:
  ...
  - xo
aliases:
  - "Reference - XO Save Context Urgency"
  - "save-context-urgency"
---
...
**Repository Path:** `plugins/xo/skills/xo/references/save-context-urgency.md`
**Source URL:** [save-context-urgency.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-context-urgency.md)
...
Provides official operational guidance and procedural requirements for the **Save Context Urgency** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/save-context-urgency.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
