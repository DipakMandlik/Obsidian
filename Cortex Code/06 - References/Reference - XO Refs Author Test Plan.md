...
title: "Reference - XO Refs Author Test Plan"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/refs-author-test-plan.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-author-test-plan.md
...
tags:
  ...
  - xo
aliases:
  - "Reference - XO Refs Author Test Plan"
  - "refs-author-test-plan"
---
...
**Repository Path:** `plugins/xo/skills/xo/references/refs-author-test-plan.md`
**Source URL:** [refs-author-test-plan.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-author-test-plan.md)
...
Provides official operational guidance and procedural requirements for the **Refs Author Test Plan** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/refs-author-test-plan.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
