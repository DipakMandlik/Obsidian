...
title: "Reference - XO Refs Workspace Setup"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/refs-workspace-setup.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-workspace-setup.md
...
tags:
  ...
  - xo
aliases:
  - "Reference - XO Refs Workspace Setup"
  - "refs-workspace-setup"
---
...
**Repository Path:** `plugins/xo/skills/xo/references/refs-workspace-setup.md`
**Source URL:** [refs-workspace-setup.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-workspace-setup.md)
...
Provides official operational guidance and procedural requirements for the **Refs Workspace Setup** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/refs-workspace-setup.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
