...
title: "Reference - XO Save Protocol"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/save-protocol.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-protocol.md
...
**Repository Path:** `plugins/xo/skills/xo/references/save-protocol.md`
**Source URL:** [save-protocol.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-protocol.md)
...
Provides official operational guidance and procedural requirements for the **Save Protocol** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/save-protocol.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
