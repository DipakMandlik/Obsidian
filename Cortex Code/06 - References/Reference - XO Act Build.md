...
title: "Reference - XO Act Build"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/act-build.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/act-build.md
...
**Repository Path:** `plugins/xo/skills/xo/references/act-build.md`
**Source URL:** [act-build.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/act-build.md)
...
Provides official operational guidance and procedural requirements for the **Act Build** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/act-build.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
