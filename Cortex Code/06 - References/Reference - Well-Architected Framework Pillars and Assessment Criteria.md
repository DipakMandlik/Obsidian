...
title: "Reference - Well-Architected Framework Pillars and Assessment Criteria"
source_repo: Snowflake-Labs/coco-skills
source_path: skills/well-architected-framework-assessment/references/
source_url: https://github.com/Snowflake-Labs/coco-skills/tree/28b549f48da9994307081a9d4d2f16379f5a9c16/skills/well-architected-framework-assessment/references
...
**Repository Path:** `skills/well-architected-framework-assessment/references/`
**Category:** Architecture Assessment
...
Defines the evaluation criteria, SQL introspection checks, and scoring rules for all 5 pillars of the Snowflake Well-Architected Framework:
...
## Canonical WAF Criteria

`📘 REFERENCE` `✅ COPY-READY`

### PILLAR: SUBAGENT_PROMPT_TEMPLATE
