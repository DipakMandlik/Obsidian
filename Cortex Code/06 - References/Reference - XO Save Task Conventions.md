...
title: "Reference - XO Save Task Conventions"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/save-task-conventions.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-task-conventions.md
...
tags:
  ...
  - xo
aliases:
  - "Reference - XO Save Task Conventions"
  - "save-task-conventions"
---
...
**Repository Path:** `plugins/xo/skills/xo/references/save-task-conventions.md`
**Source URL:** [save-task-conventions.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/save-task-conventions.md)
...
Provides official operational guidance and procedural requirements for the **Save Task Conventions** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/save-task-conventions.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
