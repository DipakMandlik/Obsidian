...
title: "Reference - XO Refs Security Review Triggers"
source_repo: Snowflake-Labs/coco-skills
source_path: plugins/xo/skills/xo/references/refs-security-review-triggers.md
source_url: https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-security-review-triggers.md
...
tags:
  ...
  - xo
aliases:
  - "Reference - XO Refs Security Review Triggers"
  - "refs-security-review-triggers"
---
...
**Repository Path:** `plugins/xo/skills/xo/references/refs-security-review-triggers.md`
**Source URL:** [refs-security-review-triggers.md](https://github.com/Snowflake-Labs/coco-skills/blob/28b549f48da9994307081a9d4d2f16379f5a9c16/plugins/xo/skills/xo/references/refs-security-review-triggers.md)
...
Provides official operational guidance and procedural requirements for the **Refs Security Review Triggers** stage of the XO operator harness in Cortex Code.
...
Directly extracted from `plugins/xo/skills/xo/references/refs-security-review-triggers.md`. This forms part of the authoritative stage reference library for Cortex Code operator workflows.
